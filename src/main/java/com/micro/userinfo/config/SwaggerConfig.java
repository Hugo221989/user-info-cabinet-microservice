package com.micro.userinfo.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.micro.userinfo"))
	...
	public ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Información del alumno del gabinete").description(
